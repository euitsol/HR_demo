...
@section('breadcrumb')
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Verbal Warning</li>
    </ul>
@endsection
@section('pageTitle', 'Verbal Warning')
@section('content')
    <div class="row mb-5">
        <div class="col-lg-10 offset-lg-1">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Create Verbal Warning</h3>
                </div>
                {{--     Form Start              --}}
                <form action="{{ route('verbalHearing.store') }}" class="form-horizontal" method="post">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="col-md-3 col-xs-12 control-label">Verbal Warning</label>
