...
@section('breadcrumb')
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">{{$menu[14]->display_name}}</li>
    </ul>
@endsection
@section('pageTitle', 'Religion Setup')
@section('content')
    <div class="row mb-5">
        ...
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Religion Entry</h3>
                </div>
                {{--     Form Start              --}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="Religion Name" name="name" required
