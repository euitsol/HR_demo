...
@endsection
@section('pageTitle', 'Pay Scale Edit')
@section('content')
    <section class="pb-5">
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">PAY SCALE EDIT</h3>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{$p->title}}" name="title" required
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" min="0" name="pay" required value="{{$p->pay}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <textarea
                                            ...
                                            rows="5" name="BenefitDetails" required>{{$p->benefit_detail}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
                                        <input type="number" step="0.01" min="0" name="familySupport"
                                               required value="{{$p->family_support}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <textarea
                                            ...
                                            rows="5" name="familySupportDetails"
