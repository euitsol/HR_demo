...
@section('breadcrumb')
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="{{route('task.comment', ['tid' => $task->id])}}">Task Comment</a>
        </li>
    </ul>
@endsection
@section('pageTitle')
            ...
            <div class="content-frame-body content-frame-body-left">
                <div class="panel panel-default push-up-10">
                    <div class="panel-body panel-body-search">
                        <form action="{{route('task.comment.store', ['tid' => $task->id])}}" method="post"
